...
class Eco_Nature_Zone_Loader {
	 ...
	 * @return void
	 */
	public function eco_nature_zone_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function eco_nature_zone_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function eco_nature_zone_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function eco_nature_zone_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->eco_nature_zone_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function eco_nature_zone_load( $class ) {
