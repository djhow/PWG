...
$eco_nature_zone_post_page_thumb =  get_theme_mod( 'eco_nature_zone_post_page_thumb', 1 );
$eco_nature_zone_post_page_content =  get_theme_mod( 'eco_nature_zone_post_page_content', 1 );
?>

<div class="col-lg-6 col-md-6 col-sm-6">
    <article id="post-<?php the_ID(); ?>" <?php post_class('article-box'); ?>>
        <?php if ($eco_nature_zone_post_page_thumb == 1 ) {?>
            <?php if ( has_post_thumbnail() ) { ?>
                <?php eco_nature_zone_post_thumbnail(); ?>
            <?php }?>
        <?php }?>
